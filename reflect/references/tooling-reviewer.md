...
- `Read` tool calls against any `SKILL.md` file (project `.claude/skills/`, user-level `~/.claude/skills/`, or plugin paths under `~/.claude/plugins/`)
- `Skill` calls, or `Agent` prompts that name a skill path
